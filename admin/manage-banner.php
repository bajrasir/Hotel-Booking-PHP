				...
				<?php
								...
								<tr>
									...
									<td>
										...
										if($image_name!="")
										{
											...
											<img src="<?php echo SITEURL; ?>images/admin/banner/<?php echo $image_name; ?>" width="100px";
											<?php
										}
										else
										{
									...
									<td style="overflow:hidden"><?php echo $description ?></td>
									<td><?php echo $active ?></td>
									<td>
									<a href="<?php echo SITEURL; ?>admin/update-banner.php?id=<?php echo $id; ?>" class="btn-secondary">Update Banner</a> 
					...
					else
					{
						...
						?>
							...
							<td colspan="6"><div class='error'>No Banner Added.</td>
							</tr>
						<?php
