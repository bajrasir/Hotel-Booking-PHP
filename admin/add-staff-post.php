...
<form action="" method="POST" enctype="multipart/form-data">
		<table class="tbl-30">
            ...
            <tr>
				<td>Post:</td>
				<td>
					<input type="text" name="post" placeholder="Staff Post">
				</td>
			</tr>
            ...
            <tr>
					<td>Facebook: </td>
					<td>
						<textarea name="facebook" cols="30" rows="5" placeholder="Facebook Link of Staff"></textarea>
					</td>
			</tr>
            ...
            <tr>
					<td>Linkedin: </td>
					<td>
						<textarea name="linkedin" cols="30" rows="5" placeholder="Linkedin Link of Staff"></textarea>
					</td>
			</tr>
				<td>Active:</td>
	...
	if (isset($_POST['submit']))
	 {
		...
		if (isset($_FILES['image']['name']))
		 {
			...
			// to upload image we need image name and source path and destination path
		 	...
		 	// get the extenstion of our image(jpg,png,gif) eg: food1.jpg
			 	...
			 	$destination_path= "../images/admin/staff/".$image_name;
			 	...
			 	if ($upload==false)
			 	 {
			 		...
			 		header('location:'.SITEURL.'admin/add-staff-post.php');
			 		// stop the process
			 		die();
        ...
        image='$image_name',
			...
			else
			{
				...
				$_SESSION['add']="<div class='error>Staff Added Failed</div>";
				header('location:'.SITEURL.'admin/add-staff-post.php');
