	...
	if(isset($_GET['id']))
	 {
		...
		else
		{
			...
			$_SESSION['no-category-found'] ="<div class='error>Banner Not Found.</div>";
							...
							if ($current_image!="")
							 {
								// display the image
								?>
								<img src="<?php echo SITEURL; ?>images/admin/banner/<?php echo $current_image; ?>" width='100px';>
								<?php
		...
		if (isset($_FILES['image']['name']))
		 {
			...
			if($image_name!="")
			{
		 	...
		 	if ($current_image!="")
		 	{
		 	 	$remove_path="../images/admin/banner/".$current_image;
		...
		if ($res2==true)
		 {
		 	...
		 	// category updated
			$_SESSION['update']="<div class='success'>Banner Successfully Updated.</div>";
			header('location:'.SITEURL.'admin/manage-banner.php');
		}
		else
		{
			// failed to update category
			$_SESSION['update']="<div class='error'>Bannner Updated Failed.</div>";
			header('location:'.SITEURL.'admin/manage-banner.php');
		}
